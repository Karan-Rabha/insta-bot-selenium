...
class Instagram:
    ...
    def notification(self):
        ...
        time.sleep(2)
        try:
            save_info = WebDriverWait(self.driver,10).until(EC.element_to_be_clickable((By.XPATH,'//*[@id="react-root"]/section/main/div/div/div/div/button')))
            save_info.click()
        except NoSuchElementException:
            print("No Save info popup found")
            pass

        '''cancle save notification'''
        time.sleep(2)
        try:
    ...
    def sendmessage(self,message):
        time.sleep(4)
        try:
            message_button = self.driver.find_element_by_xpath('//*[@id="react-root"]/section/main/div/header/section/div[1]/div[1]/div/div[1]/button')
            ...
            time.sleep(4)
            text_area = self.driver.find_element_by_xpath('//*[@id="react-root"]/section/div/div[2]/div/div/div[2]/div[2]/div/div[2]/div/div/div[2]/textarea')
            if type(message) == str:
                ...
                print("Either the message be a string or a list of message")
                self.driver.quit()
